...
const Index = () => {
  ...
  const banners = [
    {
      title: "Замена экрана на любом планшете, ноутбуке, смартфоне",
      description:
    ...
    },
    {
      ...
      description:
        "Установка программ, восстановление данных, замена комплектующих. Техническое обслуживание. Ускорение системы. Модернизация.",
      image:
    ...
    },
    {
      ...
      description:
        "Чистка системы охлаждения, замена экрана, клавиатуры. Замена жесткого диска. Установка программ. Ремонт после другого сервисного центра.",
      image:
    ...
    },
    {
      ...
      description:
        "Ремонт лазерных, струйных принтеров и МФУ. Восстановление печатающих головок Epson. Продажа чернил и картриджей.",
      image:
    ...
    },
    {
      ...
      description:
        "Замена подсветки, ремонт материнских плат и блоков питания. Покупка неисправной техники.",
      image:
  ...
  const repairs = [
    {
      ...
      items: [
        "Замена экранов на любой смартфон. Работаем со всеми производителями.",
        "Электрический ремонт любой сложности",
        "Восстановление ПО. Разблокировка",
        "Замена разъемов зарядки, наушников, коннекторов экрана",
        "Замена сим коннекторов, корпусов, задних крышек, стекла камеры",
...

    {
      ...
      items: [
        "Установка программ Windows, Office, антивирус",
        "Восстановление данных с поврежденных носителей и после удаления",
        "Восстановление данных с USB Flash, HDD, SSD",
        "Ремонт системы охлаждения, замена термопасты процессора и видеокарты ",
        "Замена экрана, клавиатуры, жесткого диска",
        "Замена аккумуляторных батарей",
        "Замена и ремонт корпусных деталей, восстановление поворотных механизмов",
        "Электрический ремонт любой сложности",
        "Продажа зарядных устройств, мышек, сумок",
        "Модернизация компьютеров, ускорение запуска системы",
      ],
    },
    {
      type: "banner",
    ...
    },
    {
      ...
      items: [
        ...
        "Продажа расходных материалов. Картриджей и чернил",
      ],
    },
    {
  ...
  const reviews = [
    ...
    },
    {
      name: "Ольга Р.",
      rating: 5,
      text: "Принесла принтер Epson — перестал печатать, выдавал ошибку головки. Прочистили, настроили, теперь работает как новый. Обслужили быстро, объяснили причину проблемы. Буду обращаться ещё!",
      date: "5 дней назад",
    },
    {
      name: "Виктор С.",
      rating: 5,
      text: "Сломался телевизор LG — картинка пропала, только звук. Диагностику сделали бесплатно, сказали что вышла подсветка. Отремонтировали за день, цена приятно удивила. Телевизор работает отлично!",
      date: "3 недели назад",
    },
    {
      name: "Наталья В.",
      rating: 5,
      text: "Компьютер жутко тормозил и перегревался. Почистили от пыли, заменили термопасту, установили SSD. Теперь летает! Очень довольна результатом, мастера знают своё дело.",
      date: "месяц назад",
    },
  ];
