...
const Index = () => {
  ...
  const banners = [
    {
      ...
      image: 'https://cdn.poehali.dev/projects/76e42107-86b0-4909-a0e6-6d5cf09e173d/files/2691e083-2fa2-411f-98ce-299105ca247c.jpg',
      icon: 'Smartphone'
    },
    {
      title: 'Ремонт компьютеров',
      description: 'Установка ПО, восстановление данных, замена комплектующих',
      image: 'https://cdn.poehali.dev/projects/76e42107-86b0-4909-a0e6-6d5cf09e173d/files/218a914f-77f6-4c7b-9e0a-b80d80d0c11b.jpg',
      icon: 'Monitor'
    },
    {
      title: 'Ремонт ноутбуков',
      description: 'Чистка системы охлаждения, замена экранов, клавиатур',
      image: 'https://cdn.poehali.dev/projects/76e42107-86b0-4909-a0e6-6d5cf09e173d/files/12718556-35ce-4712-b107-cfaaa47f29b7.jpg',
      icon: 'Laptop'
    },
    {
      title: 'Ремонт принтеров и МФУ',
      description: 'Прочистка головки, замена деталей, продажа расходников',
      image: 'https://cdn.poehali.dev/projects/76e42107-86b0-4909-a0e6-6d5cf09e173d/files/0444682b-2440-4411-8575-91d0a9cfc4b2.jpg',
      icon: 'Printer'
    },
    {
      title: 'Ремонт телевизоров',
      description: 'Замена матрицы, подсветки, ремонт блоков питания',
      image: 'https://cdn.poehali.dev/projects/76e42107-86b0-4909-a0e6-6d5cf09e173d/files/71c70a93-ac6c-4eef-9dff-6597a6a8ed1b.jpg',
      icon: 'Tv'
    }
  ];
  ...
  const workflow = [
    {
      number: 1,
      title: 'Приносите изделие',
      description: 'Вы приносите к нам ваше неисправное изделие',
      icon: 'Package'
    },
    {
      number: 2,
      title: 'Диагностика',
      description: 'Наш мастер проводит осмотр-диагностику в течение 1 рабочего дня',
      icon: 'Search'
    },
    {
      number: 3,
    ...
    },
    {
      number: 4,
      title: 'Ремонт',
      description: 'Производим ремонт от 1 до 3 рабочих дней при наличии запчастей',
      icon: 'Wrench'
    },
    {
      number: 5,
  ...
  return (
    <div className="min-h-screen bg-white">
      <header className={`sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm transition-all duration-300 ${isScrolled ? 'py-2' : 'py-4'}`}>
        <div className="container mx-auto px-4">
          <div className={`flex items-center justify-between transition-all duration-300 ${isScrolled ? 'gap-4' : 'flex-col lg:flex-row gap-4'}`}>
            <div className="flex items-center gap-3">
              <div className="relative">
                <div className={`bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg transition-all duration-300 ${isScrolled ? 'h-12 w-12' : 'h-16 w-16'}`}>
                  <Icon name="Zap" className="text-white" size={isScrolled ? 24 : 32} />
                </div>
              ...
              <div>
                ...
                {!isScrolled && <p className="text-sm text-gray-600">Профессиональный ремонт техники</p>}
              </div>
            </div>
          ...
          >
            ...
            <div className="relative container mx-auto px-4 h-full flex items-center">
              <div className="max-w-2xl text-white">
                ...
                <h2 className="text-5xl lg:text-6xl font-bold mb-6">{banner.title}</h2>
                <p className="text-2xl mb-8 text-gray-200">{banner.description}</p>
                <Button
                  size="lg"
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="border-2 border-orange-200 shadow-xl">
              <CardHeader className="text-center bg-gradient-to-r from-orange-50 to-white">
                ...
                <CardTitle className="text-3xl text-gray-900">Проверить статус ремонта</CardTitle>
              ...
              <CardContent>
                  ...
                  {[
                    ...
                    <div key={idx} className="flex items-start gap-4">
                      <div className={`flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center ${
                        item.current ? 'bg-orange-600 animate-pulse' : item.done ? 'bg-green-100' : 'bg-gray-200'
                      }`}>
                        <Icon
                      ...
                      <div className="flex-1">
                        ...
                        {item.current && <Badge className="mt-2 bg-orange-600">Текущий этап</Badge>}
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-8 p-6 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl border-2 border-orange-200">
                  ...
                  <p className="text-gray-700">
                    На протяжении всего ремонта вы получаете уведомления о статусах ремонта
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section id="repairs" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-orange-600 text-white px-6 py-2 text-base">Услуги</Badge>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {repairs.map((repair, index) => (
              <Card key={index} className="border-2 hover:border-orange-300 transition-all hover:shadow-xl">
                <CardHeader>
      ...
      <section id="workflow" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-green-600 text-white px-6 py-2 text-base">Процесс</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">Как мы работаем</h2>
            <p className="text-xl text-gray-600">Простой и прозрачный процесс ремонта</p>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
                ...
                <div key={index} className="relative">
                  <Card className="text-center hover:shadow-xl transition-all border-2 hover:border-orange-300">
                    <CardContent className="pt-6">
                      ...
                      <div className="text-3xl font-bold text-orange-600 mb-2">{step.number}</div>
            ...
            <div className="mt-12 p-8 bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl border-2 border-orange-200 text-center">
              <Icon name="Bell" className="text-orange-600 mx-auto mb-4" size={48} />
      ...
      <section id="contact-form" className="py-20 bg-gradient-to-br from-orange-500 to-orange-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4">Сделайте заказ прямо сейчас</h2>
      ...
      <section id="brands" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-orange-600 text-white px-6 py-2 text-base">Производители</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Ремонтируем оборудование всех брендов
            </h2>
            <p className="text-xl text-gray-600">И многие другие производители</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-5xl mx-auto">
            {brands.map((brand, index) => (
              ...
              >
                ...
                {brand.popular && (
                  <Badge className="mt-2 bg-orange-600 text-white">Популярный</Badge>
                )}
              </div>
            ))}
          </div>
      ...
      <section id="equipment" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-green-600 text-white px-6 py-2 text-base">Оборудование</Badge>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              С каким оборудованием работаем?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section id="contact" className="py-20 bg-gradient-to-br from-orange-500 to-orange-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl lg:text-5xl font-bold mb-4">Свяжитесь с нами прямо сейчас</h2>
              <p className="text-xl text-orange-100">Мы всегда рады помочь вам</p>
            </div>
              ...
              <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-orange-100 text-lg">
                    <a href="tel:83952407405" className="hover:text-white transition-colors">
                      8-3952-407-405
                    </a>
                  </CardDescription>
                </CardHeader>
              ...
              <Card className="bg-white/10 backdrop-blur-md border-white/20 text-white">
                <CardHeader className="text-center">
                  ...
                  <CardDescription className="text-orange-100 text-base break-all">
                    <a href="mailto:89245401717@mail.ru" className="hover:text-white transition-colors">
                      89245401717@mail.ru
                    </a>
                  </CardDescription>
                </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-2xl text-center">Форма обратной связи</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Приходите к нам прямо сейчас</h2>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl">
                <Icon name="CheckCircle2" className="text-green-600" size={28} />
                <div className="text-left">
                  <div className="font-semibold text-gray-900">Удобный вход</div>
              ...
              <div className="flex items-center gap-3 p-4 bg-green-50 rounded-xl">
                <Icon name="CheckCircle2" className="text-green-600" size={28} />
                <div className="text-left">
                  <div className="font-semibold text-gray-900">Без очередей</div>
                  <div className="text-sm text-gray-600">Быстрое обслуживание</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            ...
            <p className="mt-2 text-sm">
              Адрес: г. Иркутск, ул. Рабочего Штаба 78, здание супермаркета «Слата», 2 этаж
            </p>
          </div>
        </div>
      </footer>
